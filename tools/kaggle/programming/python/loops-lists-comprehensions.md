...
A for-loop iterates over items in a collection such as a list, tuple, or even a string. Example: looping through a list of planets or printing uppercase letters in a sentence.
```
