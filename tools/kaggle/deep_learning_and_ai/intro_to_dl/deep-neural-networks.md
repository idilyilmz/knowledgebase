...
- each layer performs a **simple transformation** of the data. 
- By stacking many layers, a neural network can gradually transform inputs into more meaningful representations, allowing it to solve complex problems.
