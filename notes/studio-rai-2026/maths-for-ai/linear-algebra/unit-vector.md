...
A **unit vector** is a vector with a length of **1** in a normed vector space. It is typically represented by a lowercase letter with a circumflex, such as 
**$$ \hat{v} $$**
. The term **normalized vector** is synonymous with unit vector.
