...
- **Developer Tools Setup**: Students need to prepare their programming environment, install **Python**, and choose an integrated development environment (IDE) such as:
  ...
  - Anaconda
  - PyCharm
- **Python Version Recommendation**: Install an older version for compatibility, e.g., Python **3.11**, **3.12**, or **3.13**.
...
- **Advantages of Python**:
  - Easy to learn.
  - Popular in data science due to accessible libraries.
  - Simple library creation.

## Virtual Environments and Packages
- Students must create a virtual environment named **‘ds’** and install the **‘pandas’** package.
- Guidance is provided through a tutorial on managing Python packages and virtual environments.
